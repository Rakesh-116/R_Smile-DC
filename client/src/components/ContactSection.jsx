...
const ContactSection = ({ openDentrixModal }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch("https://formsubmit.co/ajax/rsddssewell@gmail.com", {
                method: "POST",
                body: formData,
            });
            ...
            <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12">
                ...
                <div>
                    ...
                    <p className="text-gray-600 mb-6">
                        Reach out with questions or book an appointment below. We’re here for you.
                    </p>
                    ...
                    <div className="space-y-4 text-sm text-gray-700">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <a href="mailto:rsddssewell@gmail.com" className="hover:underline">
                ...
                <div>
                    ...
                    <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div className="flex items-start gap-2 sm:col-span-2 text-sm">
                            <input type="checkbox" required className="mt-1 accent-blue-600" id="consent" />
                            <label htmlFor="consent" className="text-gray-600">
                                By submitting this form, you agree to send your information by email. Do not include
