    ...
    <div className="mt-20">
      ...
      <section className="bg-gray-50 py-12 px-6 text-center mb-16">
        <blockquote className="text-2xl md:text-3xl font-semibold text-gray-800 max-w-4xl mx-auto">
          “I still carry an unrealistic fear of going to the dentist from
          childhood. All of that evaporates the minute I step into the office.
          The staff is friendly and every person makes me feel special.”
        </blockquote>
